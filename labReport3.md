...
<br>
**Searching for just "men" is important because I would like to see what article is talking about men and not the governMENt.**
<br>
...
<br>
**The above example is important because I would like to view lines that only contain "legal" and not "illegal". Maybe I would like to see the context of how many times "illegal" is used vs. "not legal".**
<br>
...
<br>
**I wanted to search for med instead of medicine to see if authors use shortened terms. **
<br>
...
<br>
**This example provides further context for the user of how the word is used in the context of after the target.**  
<br>
...
<br>
**This example is important because it demonstrates how to find alien as its own word without case sensitivity. (Searches for Alien, alien, AlIeN, etc....)**  
<br>
...
<br>
**I wanted to search for all "trial"s that are not substrings in order to see each case in the different directories.**
<br>
...
<br>
**It is also may be important for a user to see how many times a word is used as a string/substring without it being case sensitive.**
<br>
